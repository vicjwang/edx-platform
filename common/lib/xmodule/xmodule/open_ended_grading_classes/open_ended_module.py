...
class OpenEndedModule(openendedchild.OpenEndedChild):
    ...
    def setup_response(self, system, location, definition, descriptor):
        ...
        # If there are multiple tasks such a self-assessment followed by ai, after
        # the status of the first task is DONE, setup_next_task() will create the
        # OpenEndedChild with parameter child_created=True so that the submission
        # can be sent to the grader. Keep trying each time this module is loaded
        # until it succeeds.
