...
def get_transcripts_from_youtube(youtube_id):
    ...
    if data.status_code != 200 or not data.text:
        ...
        raise GetTranscriptsFromYouTubeException(_(msg))
...
def generate_subs_from_source(speed_subs, subs_type, subs_filedata, item):
    ...
    try:
        ...
        msg = "Something wrong with SubRip transcripts file during parsing. Inner message is "
        raise TranscriptsGenerationException(_(msg) + e.message)
    if not srt_subs_obj:
